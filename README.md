...
## Features:
 ...
 - Search from a wide variety of trees indexed in the [Trefle API](https://trefle.io/).
 - Maps used from [Mapbox](https://www.mapbox.com/).
...
3. ### If everything goes well, visit the app at localhost:3000 in your browser
...
**Tree routes**:\
`POST /v1/trees` - create a tree\
`GET /v1/trees` - get all trees\
`GET /v1/trees/search/:query` - search for trees\
